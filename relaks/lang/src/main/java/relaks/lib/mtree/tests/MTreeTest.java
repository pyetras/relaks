package relaks.lib.mtree.tests;

import relaks.lib.mtree.utils.Pair;
import relaks.lib.mtree.utils.Utils;
import org.junit.Test;
import relaks.lib.mtree.*;
...
public class MTreeTest {
	...
	private void _checkNearestByRange(Data queryData, double radius) {
		List<MTreeClass.ResultItem> results = new ArrayList<>();
		Set<Data> strippedResults = new HashSet<>();
